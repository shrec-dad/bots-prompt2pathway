...
export default function Embed() {
  ...
  // This works both in dev and on Lovable preview because it uses the current origin.
  ...
  }, [origin, botId, mode, position, size, color]);
...
></iframe>`,
  ...
  // React snippet assumes you install/use your local ChatWidget component
...
export default function App() {
  return (
    ...
    [mode, botId, color, size, position]
  );
  ...
  const sectionCard =
    "rounded-2xl border bg-white/90 p-4 md:p-5 shadow-sm";
    ...
    <div className="p-6 space-y-6">
      ...
      <div className={sectionCard}>
        ...
        <p className="text-xs text-muted-foreground mt-2">
          ...
          <code>/widget</code> and carries your selected options as query params.
        </p>
      </div>
      ...
      <div className={sectionCard}>
        ...
        <p className="text-xs text-muted-foreground mt-2">
          This uses your existing <code>src/widgets/ChatWidget.tsx</code> component. Great for
          React apps you control.
        </p>
      </div>
    </div>
  );
