...
export default function NurturePage() {
  const initial = useMemo<NurtureStep[]>(
    () => getJSON<NurtureStep[]>(KEY, Array.from({ length: 14 }, () => ({
  ...
  return (
    <div className="admin-page bg-grad-pink">
      ...
      <div className="admin-section stack">
        <p>Create simple 7–14 day sequences now. This page has placeholders ready to wire to your email service later.</p>
